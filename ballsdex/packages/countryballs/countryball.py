...
spawnmsglist = [
    ...
    "99% of Kisserdex players give up before they get a mythic.",
    ...
    "those who grow: 🪴",
    "This kisser cannot afford a home due to inflation.",
    "Maybe you should catch them.",
